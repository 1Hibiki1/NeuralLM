...
class NeuralBertForPreTraining(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.bert = NeuralBertModel(config)
...
class NeuralBertForSequenceClassification(BertPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
...
class NeuralBertForMaskedLM(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.bert = NeuralBertModel(config, add_pooling_layer=False)
